...
class AttValueMapperTests {
    ...
    fun `test mapper attribute value when data type is string`() {
        val result = mapper
            .getAttributeValue(TableTemplateItemMoshi("name", ItemType.STRING, false, "value", false, false))
    ...
    fun `test mapper attribute value when data type is int`() {
        val result = mapper
            .getAttributeValue(TableTemplateItemMoshi("name", ItemType.INT, false, "value", false, false))
    ...
    fun `test mapper attribute value when data type is boolean true`() {
        val result = mapper
            .getAttributeValue(TableTemplateItemMoshi("name", ItemType.BOOLEAN, false, "true", false, false))
    ...
    fun `test mapper attribute value when data type is boolean false`() {
        val result = mapper
            .getAttributeValue(TableTemplateItemMoshi("name", ItemType.BOOLEAN, false, "false", false, false))
    ...
    fun `test mapper attribute value when data type is boolean 1`() {
        val result = mapper
            .getAttributeValue(TableTemplateItemMoshi("name", ItemType.BOOLEAN, false, "1", false, false))
        assert(result.bool() == true)
    }
    ...
    fun `test mapper attribute value when data type is boolean 0`() {
        val result = mapper
            .getAttributeValue(TableTemplateItemMoshi("name", ItemType.BOOLEAN, false, "0", false, false))
        assert(result.bool() == false)
    }
    ...
    fun `test mapper attribute value when data type is UTC date`() {
        val result = mapper
            .getAttributeValue(TableTemplateItemMoshi("name", ItemType.UTC_DATE, false, "2025-04-20", false, false))
